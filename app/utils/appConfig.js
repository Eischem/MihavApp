export const appConfig = {
  appName: 'MiHav App',
  aboutUs:
    'Herkese Merhaba, MİHAV uygulaması 2023 yılında siz değerli kullanıcılarımızla buluşmuştur. Uygulamamız sahipsiz hayvanlar için ülkemizde sokaklara konulan beslenme ünite durumlarının takibi için oluşturulmuştur. Beslenme üniteleri, mama ve su olmak üzere hayvanların ihtiyacını karşılayabileceği 2 bölümden oluşmuştur. Bu bölümler, ünite içerisinde bulunan depolarla desteklenmektedir. Depolarda bulunan mama ve suyun miktarlarını uygulamamızda görebilirsiniz. Depolarda azami miktara düşen mama ve su miktarına gelen üniteler uygulama aracılığıyla görevliye alarm gönderir. Böylelikle ünitelerdeki depolar görevliler tarafından doldurulmaktadır. Uygulamamız herkese açıktır. Beslenme ünitelerini görebilirsiniz. Sahipsiz hayvanların sürekli beslenebilmesi için projeye destek çıkmak isteyen herkes uygulamamıza üye olup bağış yapabilmektedir. Yapılan bağış sahipsiz hayvanlara mama alınması için kullanılmaktadır.',
  unitsInfo:
